...
use App\Models\Review; // TAMBAHAN BARU
use Carbon\Carbon;
...
public function index(Request $request)
{
    ...
    $selectedVenueType = $request->get('venue', 'pvj'); // Default PVJ
    
    // ============ DATA 4 VENUE (MASING-MASING 5 GAMBAR) ============
    $venues = [
    'cibadak_a' => [
        'id' => 1,
        ...
        'images' => [
            'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=1200', // Indoor court
            'https://images.unsplash.com/photo-1519861531473-9200262188bf?w=1200', // Basketball game
            'https://images.unsplash.com/photo-1608245449230-4ac19066d2d0?w=1200', // Court view
            'https://images.unsplash.com/photo-1504450874802-0ba2bcd9b5ae?w=1200', // Basketball hoop
            'https://images.unsplash.com/photo-1574623452334-1e0ac2b3ccb4?w=1200', // Facility
        ],
        'facilities' => [
            'Cafe & Resto',
            'Parkir Mobil Luas',
    ...
    'cibadak_b' => [
        ...
        'images' => [
            'https://images.unsplash.com/photo-1504450874802-0ba2bcd9b5ae?w=1200', // Outdoor court
            'https://images.unsplash.com/photo-1515523110800-9415d13b84a8?w=1200', // Night basketball
            'https://images.unsplash.com/photo-1574623452334-1e0ac2b3ccb4?w=1200', // Court night
            'https://images.unsplash.com/photo-1608245449230-4ac19066d2d0?w=1200', // Basketball
            'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=1200', // Court view
        ],
        'facilities' => [
            'Kantin',
            'Area Parkir Luas',
    ...
    'pvj' => [
        ...
        'price_per_session' => 350000,
        'images' => [
            'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=1200', // Mall court
            'https://images.unsplash.com/photo-1519861531473-9200262188bf?w=1200', // Indoor premium
            'https://images.unsplash.com/photo-1608245449230-4ac19066d2d0?w=1200', // Basketball action
            'https://images.unsplash.com/photo-1504450874802-0ba2bcd9b5ae?w=1200', // Court detail
            'https://images.unsplash.com/photo-1574623452334-1e0ac2b3ccb4?w=1200', // Facilities
        ],
        'facilities' => [
            'Cafe & Resto',
            'Parkir Mall 24 Jam',
    ...
    'urban' => [
        ...
        'images' => [
            'https://images.unsplash.com/photo-1574623452334-1e0ac2b3ccb4?w=1200', // Modern court
            'https://images.unsplash.com/photo-1515523110800-9415d13b84a8?w=1200', // Professional court
            'https://images.unsplash.com/photo-1504450874802-0ba2bcd9b5ae?w=1200', // Urban style
            'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=1200', // Premium facility
            'https://images.unsplash.com/photo-1519861531473-9200262188bf?w=1200', // Court action
        ],
        'facilities' => [
            'Cafe Premium',
    ...
    return Inertia::render('HomePage/Booking/Booking', [
        ...
        'venue' => $venue,
        'venues' => $venues, // ← Kirim semua venues untuk selection
        'schedules' => $schedules,
    ...
    public function processBooking(Request $request)
{
    $validated = $request->validate([
        ...
        'venue_type' => 'required|string|in:cibadak_a,cibadak_b,pvj,urban', // ← UPDATE INI
    ]);
        ...
        try {
            ...
            $booking = Booking::create([
                ...
                'status' => 'pending',
                'payment_status' => 'pending', // TAMBAHAN INI
            ...
            if ($request->expectsJson() || $request->is('api/*')) {
                return response()->json([
                    ...
                    'booking_id' => $booking->id,
                    'redirect_to_profile' => true, // TAMBAHAN
...
{
    $reviews = Review::with('client:id,name,profile_image') // TAMBAH profile_image
        ->latest()
        ->take(8)
        ->get()
        ->map(function($review) {
            return [
                'id' => $review->id,
                'client_name' => $review->client->name,
                'client_profile_image' => $review->client->profile_image, // ← TAMBAHAN INI
                'rating' => $review->rating,
                'comment' => $review->comment,
                'created_at' => $review->created_at->diffForHumans(),
            ];
